...
namespace MVCSampleBrowser.Controllers
{
    public partial class MapsController : Controller
    {
        ...
        public ActionResult DrillDown()
        {
            ...
            ViewData["datasource"] = Continent_CountriesData.GetContinentCountriesData();
            ViewData["mapSalesData"] = this.GetSalesCountryData();
            ViewData["continentMapdata"] = this.GetContinentMap();
            ViewData["continentSalesMapdata"] = this.GetContinentSalesMap();
            ViewData["africaMapdata"] = this.GetAfricaMap();
            ViewData["asiaMapdata"] = this.GetAsiaMap();
            ViewData["europeMapdata"] = this.GetEuropeMap();
            ViewData["randomcountriesData"]=null;
            ViewData["northAmericaMapdata"] = this.GetNorthAmericaMap();
            ViewData["oceaniaMapdata"] = this.GetOceaniaMap();
            ViewData["southAmericaMapdata"] = this.GetSouthAmericaMap();
            ViewData["countriesRandomData"] = Countries_RandomData.GetCountriesRandomData();
            return View();
        }
    ...
    public class Continent_CountriesData
    {
