...
namespace MVCSampleBrowser.Controllers
{
    public partial class PresentationController : Controller
    {
        ...
        public ActionResult ModifyingChart(string Browser)
        {
            Stream readFile = new FileStream(ResolveApplicationDataPath(@"..\Presentation\ChartInput.pptx"), FileMode.Open, FileAccess.Read, FileShare.Read);
