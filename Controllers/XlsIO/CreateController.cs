    ...
    public partial class XlsIOController : Controller
    {
        ...
        public ActionResult Create(string SaveOption)
        {
            ...
            else
            {
                ...
                return excelEngine.SaveAsActionResult(workbook, "CreateSpreadSheet.xlsx", HttpContext.ApplicationInstance.Response, ExcelDownloadType.PromptDialog, ExcelHttpContentType.Excel2016);
            }          
