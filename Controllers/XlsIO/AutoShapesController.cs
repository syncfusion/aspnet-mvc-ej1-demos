...
namespace MVCSampleBrowser.Controllers
{
    public partial class XlsIOController : Controller
    {
        ...
        public ActionResult AutoShapes(string button)
        {
            if (button == null)
                return View();
            ...
            shape.Fill.ForeColor = System.Drawing.Color.FromArgb(245, 147, 30);
            ...
            shape.TextFrame.TextRange.RichText.SetFont(0, 0, font2);
            shape.Line.Visible = false;
            shape.Fill.ForeColor = System.Drawing.Color.FromArgb(153, 175, 60);
            shape.TextFrame.VerticalAlignment = ExcelVerticalAlignment.MiddleCentered;
            ...
            shape.TextFrame.TextRange.RichText.SetFont(0, 0, font2);
            shape.Line.Visible = false;
            shape.Fill.ForeColor = System.Drawing.Color.FromArgb(236, 28, 36);
            shape.TextFrame.VerticalAlignment = ExcelVerticalAlignment.MiddleCentered;
            ...
            shape.TextFrame.TextRange.RichText.SetFont(0, 0, font2);
            shape.Line.Visible = false;
            shape.Fill.ForeColor = System.Drawing.Color.FromArgb(248, 188, 25);
            shape.TextFrame.VerticalAlignment = ExcelVerticalAlignment.MiddleCentered;
            ...
            shape.TextFrame.TextRange.RichText.SetFont(0, 0, font2);
            shape.Line.Visible = false;
            shape.Fill.ForeColor = System.Drawing.Color.FromArgb(93, 193, 208);
            shape.TextFrame.VerticalAlignment = ExcelVerticalAlignment.MiddleCentered;
            #endregion

            try
            {
                return excelEngine.SaveAsActionResult(workbook, "AutoShapes.xlsx", HttpContext.ApplicationInstance.Response, ExcelDownloadType.PromptDialog, ExcelHttpContentType.Excel2016);
            }
            catch (Exception)
            {
            }
