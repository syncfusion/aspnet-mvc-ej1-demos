...
namespace MVCSampleBrowser.Controllers
{
    public partial class PdfController : Controller
    {
        ...
        public ActionResult XFAFormCreation(string submit, string InsideBrowser)
        {            
            if (submit == "Create PDF")
            {
                ...
                {
                    return doc.ExportAsActionResult("sample.pdf",PdfXfaType.Static, HttpContext.ApplicationInstance.Response, HttpReadType.Open);                   
                }
                else
                {
                    return doc.ExportAsActionResult("sample.pdf",PdfXfaType.Static, HttpContext.ApplicationInstance.Response, HttpReadType.Save);
                }
            }
            return View();
        }
