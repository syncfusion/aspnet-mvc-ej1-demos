...
namespace MVCSampleBrowser.Controllers.TreeGrid
{
    ...
    {
        //
        // GET: /TreeGridContextMEnu/

        public ActionResult TreeGridContextMenu()
        {
            ViewBag.datasource = this.GetContextMenuDataSource();
            return View();
        }
        private List<BusinessObject> GetContextMenuDataSource()
        {
