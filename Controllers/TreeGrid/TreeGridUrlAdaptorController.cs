...
namespace MVCSampleBrowser.Controllers.TreeGrid
{
    public partial class TreeGridController : Controller
    {
        ...
        public ActionResult TreeGridUrlAdaptor()
        {
            return View();
        }
        ...
        public ActionResult UrlUpdate(TreeGridProjectData value)
        {
        ...
        public ActionResult UrlInsert(TreeGridProjectData value)
        {
    ...
    public class DataSource
    {
        ...
        public List<TreeGridProjectData> GetUrlDataSource()
        {
