...
namespace MVCSampleBrowser.Controllers.TreeGrid
{
    ...
    {
        //
        // GET: /TreeGridCustomContextMenu/

        public ActionResult TreeGridCustomContextMenu()
        {
            ViewBag.datasource = this.GetCustomContextMenuDataSource();
            return View();
        }
        private List<BusinessObject> GetCustomContextMenuDataSource()
        {
