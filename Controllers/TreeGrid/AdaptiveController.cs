...
namespace MVCSampleBrowser.Controllers.TreeGrid
{
    public partial class TreeGridController : Controller
    {
        ...
        public ActionResult AdaptiveTreegrid()
        {
            ViewBag.datasource = this.GetAdaptiveDataSource();
            return PartialView();
        }

        private List<BusinessObject> GetAdaptiveDataSource()
        {
