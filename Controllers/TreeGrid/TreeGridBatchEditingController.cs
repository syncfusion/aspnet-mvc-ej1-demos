...
namespace MVCSampleBrowser.Controllers.TreeGrid
{
    ...
    {
        //
        // GET: /TreeGridBatchEditing/

        public ActionResult TreeGridBatchEditing()
        {
            ViewBag.datasource = this.GetBatchEditingDataSource();
            return View();
        }

        private List<BusinessObject> GetBatchEditingDataSource()
        {
            ...
            BusinessObjectCollection.Add(Record4);
            BusinessObjectCollection.Add(Record5);
            BusinessObjectCollection.Add(Record6);
