...
namespace MVCSampleBrowser.Controllers
{
    public partial class DiagramController : Controller
    {
        ...
        public ActionResult Default()
        {
            ...
            GenerateFlowShapes(symbolpalette);
            GenerateConnectors(symbolpalette);

            CreateNode("NewIdea", 150, 60, 300, 60, "New idea identified", FlowShapes.Terminator,model);
            CreateNode("Meeting", 150, 60, 300, 155, "Meeting with board", FlowShapes.Process, model);
            CreateNode("BoardDecision", 150, 110, 300, 280, "Board decides \nwhether \nto proceed", FlowShapes.Decision, model);
            CreateNode("Project", 150, 100, 300, 430, "Find Project \nmanager", FlowShapes.Decision, model);
            CreateNode("End", 150, 60, 300, 555, "Implement and Deliver", FlowShapes.Process, model);
            CreateNode("Decision", 250, 60, 550, 60, "Decision Process for new software ideas", FlowShapes.Card, model);
            CreateNode("Reject", 150, 60, 550, 285, "Reject and write report", FlowShapes.Process, model);
            CreateNode("Resources", 150, 60, 550, 430, "Hire new resources", FlowShapes.Process, model);

            createConnector("connector1", "NewIdea", "Meeting", null, model);
            createConnector("connector2", "Meeting", "BoardDecision", null, model);
            createConnector("connector3", "BoardDecision", "Project", "Yes", model);
            createConnector("connector4", "Project", "End", "Yes", model);
            createConnector("connector5", "BoardDecision", "Reject", "No", model);
            createConnector("connector6", "Project", "Resources", "No", model);
        ...
        public void CreateNode(string name, double width, double height, double offsetX, double offsetY, string text, FlowShapes shape,DiagramProperties model)
        {
        ...
        public void createConnector(string name, string sourceNode, string targetNode, string text,DiagramProperties model)
        {
        ...
        public void GenerateFlowShapes(SymbolPaletteProperties symbolpalette)
        {
        ...
        public void GenerateConnectors(SymbolPaletteProperties symbolpalette)
        {
