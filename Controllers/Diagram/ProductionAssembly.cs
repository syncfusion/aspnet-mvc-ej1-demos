...
namespace MVCSampleBrowser.Controllers
{
    public partial class DiagramController : Controller
    {
        ...
        public ActionResult ProductionAssembly()
        {
            ...
            Label label1 = new Label() {Text = "Inventory", FontSize = 22, FontColor = "black", Bold = true, HorizontalAlignment = HorizontalAlignment.Left, Offset = new DiagramPoint(){ X = 1.2f, Y = .5f }, Wrapping = TextWrapping.NoWrap };
            ...
            Label label2 = new Label() { Text = "Station Status", FontSize = 22, FontColor = "black", Bold = true, HorizontalAlignment = HorizontalAlignment.Left, Offset = new DiagramPoint() { X = 1.2f, Y = .5f }, Wrapping = TextWrapping.NoWrap };
            ...
            Label label3 = new Label() { Text = "Assembly Line Layout", FontSize = 22, FontColor = "black", Bold = true, HorizontalAlignment = HorizontalAlignment.Left, Offset = new DiagramPoint() { X = 1.2f, Y = .5f }, Wrapping = TextWrapping.NoWrap };
            ...
            model.Nodes.Add(group1);
            model.Nodes.Add(group2);
            model.Nodes.Add(group3);
            model.Nodes.Add(group4);
            model.Nodes.Add(group5);
            model.Nodes.Add(group6);
            model.Nodes.Add(group7);
            model.Nodes.Add(group8);
            model.Nodes.Add(group9);
            model.Nodes.Add(group10);
        ...
        private Node CreateNativeNode(string name, double width, double height, double offsetx, double offsety, string id, string text, string position, double angle, string border)
        {
            ...
            Label label = new Label() { Text = text, FontSize = 18, FontFamily = "segoe UI", FontColor = fontColor, Bold = true, HorizontalAlignment = horizontalAlignment, Wrapping = TextWrapping.NoWrap };
           if (position == "top")
        ...
        private Node CreateDiagramNode(string name, int width, int height, double x, double y, string text, float labelX, float labelY, string fillColor)
        {
            ...
            node.OffsetX = x;
            node.OffsetY = y;
            Label label = new Label() { Text = text, FontSize = 18, FontFamily = "segoe UI" };
        ...
        private Node CreateNode(string name, double width, double height, double offsetx, double offsety, BasicShapes shape, string text, double corner, string fillColor, double opacity)
        {
            ...
            Label label = new Label() { Text = text, FontSize = 18, FontFamily = "segoe", FontColor = "white", Bold = true };
            node.Labels.Add(label);
             if (shape != null)
              node.Shape = shape;
            else
