...
namespace MvcSampleBrowser_2012.Controllers
{
    ...
    {
        #region doc to PDF
        public ActionResult DOCtoPDF(string button, string renderingMode, string renderingMode1, string renderingMode2, string renderingMode3, string renderingMode4, string renderingMode5, HttpPostedFileBase file)
        {
            if (button == null)
                return View();
            if (file != null)
