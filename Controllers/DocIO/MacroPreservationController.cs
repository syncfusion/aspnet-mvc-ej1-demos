    ...
    public partial class DocIOController : Controller
    {
        ...
        public ActionResult MacroPreservation(string Button)
        {
            ...
            if (Button == "View Template")
                return new TemplateResult("MacroTemplate.dotm", ResolveApplicationDataPath("App_Data\\DocIO"), HttpContext.ApplicationInstance.Response);

            try
            {
                // Load the template.
                WordDocument document = new WordDocument(ResolveApplicationDataPath("MacroTemplate.dotm", "App_Data\\DocIO"));
