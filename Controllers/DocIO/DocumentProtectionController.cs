...
namespace MvcSampleBrowser_2012.Controllers
{
    public partial class DocIOController : Controller
    {
        ...
        public ActionResult DocumentProtection(string Protection_Type, string Password1, string Group2)
        {
            ...
            {
                document = new WordDocument(ResolveApplicationDataPath("TemplateFormFields.doc", "App_Data\\DocIO"));
            ...
            {
                document = new WordDocument(ResolveApplicationDataPath("TemplateComments.doc", "App_Data\\DocIO"));
            ...
            {
                document = new WordDocument(ResolveApplicationDataPath("TemplateRevisions.doc", "App_Data\\DocIO"));
            ...
            {
                document = new WordDocument(ResolveApplicationDataPath("Essential DocIO.doc", "App_Data\\DocIO"));
