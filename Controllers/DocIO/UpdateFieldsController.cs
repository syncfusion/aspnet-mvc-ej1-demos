    ...
    public partial class DocIOController : Controller
    {
        ...
        public ActionResult UpdateFields(string Group1, string Button)
        {
            ...
            if (Button == "View Template")
                return new TemplateResult("TemplateUpdateFields.docx", ResolveApplicationDataPath("App_Data\\DocIO"), HttpContext.ApplicationInstance.Response);

            //Loads the template document.
            WordDocument document = new WordDocument(ResolveApplicationDataPath("TemplateUpdateFields.docx", "App_Data\\DocIO"));

            //Initialize DataSet object.
            DataSet ds = new DataSet();

            //Load data from the xml document.
            ds.ReadXml(ResolveApplicationDataPath("StockDetails.xml", "App_Data\\DocIO"));
