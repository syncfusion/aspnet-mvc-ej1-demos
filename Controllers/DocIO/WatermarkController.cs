...
namespace MvcSampleBrowser_2012.Controllers
{
    public partial class DocIOController : Controller
    {
        public ActionResult Watermark(string Group1, string Group2)
        {
            ...
            WordDocument doc = new WordDocument(ResolveApplicationDataPath("Watermark.doc", "App_Data\\DocIO"));
            ...
            else
            {
                ...
                //Set the picture.
                picWatermark.Picture = System.Drawing.Image.FromFile(ResolveApplicationDataPath("Northwind_logo.png", "Content\\DocIO"));
