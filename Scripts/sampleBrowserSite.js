...
$(function () {
    ...
    var loadSamplePage = function (control, currentSample, categories) {
        ...
        $('#ref_document').attr('href', sample.ugurl ? sample.ugurl : 'http://help.syncfusion.com/aspnetmvc');
...
function paintTheme(e){
	window.open("http://js.syncfusion.com/themestudio/","_blank");
}

//EJ2 Sample 
function ej2Switch(e){
    document.getElementById('ej2popup').style.display = 'none';
	window.open("http://ej2.syncfusion.com/home/aspnetmvc.html?utm_source=ej1&utm_medium=banner&utm_campaign=migrate","_blank");
}

function goToSyncfusion(e) {
    window.open("http://www.syncfusion.com", "_blank");
}
