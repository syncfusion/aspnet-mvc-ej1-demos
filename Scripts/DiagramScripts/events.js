...
function listSavedDiagrams(key) {
    ...
    */
    ...
    checkbox.setAttribute("style", "background-image: url('../../Content/diagram/images/Close.png');background-repeat: no-repeat;float: right;height: 18px;margin-right: 12px;width: 20px;display:none;");
