...
function minizedPaletteOption(option, parentNode) {
    ...
    var attr = {
        ...
        "style": "height: 40px; width: 100%; background-image: url(../../Content/diagram/images/" + backgroundImage + ");"
    };
    if (option === "overview") {
...
function clearText() {
    ...
    document.getElementById("searchClear_Maxi").style.backgroundImage = 'url("../../Content/diagram/images/Search-Find.png")';
    if (document.getElementById("searchClear_Mini")) {
        document.getElementById("txtSearch_Mini").value = "";
        document.getElementById("searchClear_Mini").style.backgroundImage = 'url("../../Content/diagram/images/Search-Find.png")';
    }
}
...
function onSearchBoxTextChange(evt) {
    ...
    if (!key) {
        if (clearDiv !== "searchClear_Mini")
            document.getElementById("symbolPalette_Parent_Mini").style.display = "none";
        document.getElementById(clearDiv).style.backgroundImage = 'url("../../Content/diagram/images/Search-Find.png")';
    }
    else {
        document.getElementById(clearDiv).style.backgroundImage = 'url("../../Content/diagram/images/Close.png")';
    }
    setToolTip();
}
