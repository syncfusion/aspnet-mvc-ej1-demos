...
namespace MVCSampleBrowser.Models
{
    ...
    public class EmployeeData
    {
        ...
        public static List<EmployeeData> GetRecords()
        {
            ...
            list.Add(new EmployeeData(10249, "TOMSP", 6, 836505, "Toms Spezialit�ten", "M�nster", "Luisenstr. 48", null, "44087", "Germany", 11.61));
            list.Add(new EmployeeData(10250, "HANAR", 4, 8367642, "Hanari Carnes", "Rio de Janeiro", "Rua do Pa�o, 67", "RJ", "05454-876", "Brazil", 65.83));
            list.Add(new EmployeeData(10251, "VICTE", 3, 8367642, "Victuailles en stock", "Lyon", "2, rue du Commerce", null, "69004", "France", 41.34));
            list.Add(new EmployeeData(10252, "SUPRD", 4, 8368506, "Supr�mes d�lices", "Charleroi", "Boulevard Tirou, 255", null, "B-6000", "Belgium", 51.3));
            list.Add(new EmployeeData(10253, "HANAR", 3, 836937, "Hanari Carnes", "Rio de Janeiro", "Rua do Pa�o, 67", "RJ", "05454-876", "Brazil", 58.17));
            list.Add(new EmployeeData(10254, "CHOPS", 5, 8370234, "Chop-suey Chinese", "Bern", "Hauptstr. 31", null, "3012", "Switzerland", 22.98));
            list.Add(new EmployeeData(10255, "RICSU", 9, 8371098, "Richter Supermarkt", "Gen�ve", "Starenweg 5", null, "1204", "Switzerland", 148.33));
            ...
            list.Add(new EmployeeData(10257, "HILAA", 4, 8374554, "HILARION-Abastos", "San Crist�bal", "Carrera 22 con Ave. Carlos Soublette #8-35", "T�chira", "5022", "Venezuela", 81.91));
            list.Add(new EmployeeData(10258, "ERNSH", 1, 8375418, "Ernst Handel", "Graz", "Kirchgasse 6", null, "8010", "Austria", 140.51));
            list.Add(new EmployeeData(10259, "CENTC", 4, 8376282, "Centro comercial Moctezuma", "M�xico D.F.", "Sierras de Granada 9993", null, "05022", "Mexico", 3.25));
            list.Add(new EmployeeData(10260, "OTTIK", 4, 8377146, "Ottilies K�seladen", "K�ln", "Mehrheimerstr. 369", null, "50739", "Germany", 55.09));
            list.Add(new EmployeeData(10261, "QUEDE", 4, 8377146, "Que Del�cia", "Rio de Janeiro", "Rua da Panificadora, 12", "RJ", "02389-673", "Brazil", 3.05));
            ...
            list.Add(new EmployeeData(10264, "FOLKO", 6, 8381466, "Folk och f� HB", "Br�cke", "�kergatan 24", null, "S-844 67", "Sweden", 3.67));
            list.Add(new EmployeeData(10265, "BLONP", 2, 838233, "Blondel p�re et fils", "Strasbourg", "24, place Kl�ber", null, "67000", "France", 55.28));
            list.Add(new EmployeeData(10266, "WARTH", 3, 8383194, "Wartian Herkku", "Oulu", "Torikatu 38", null, "90110", "Finland", 25.73));
            list.Add(new EmployeeData(10267, "FRANK", 4, 8385786, "Frankenversand", "M�nchen", "Berliner Platz 43", null, "80805", "Germany", 208.58));
            list.Add(new EmployeeData(10268, "GROSR", 8, 838665, "GROSELLA-Restaurante", "Caracas", "5� Ave. Los Palos Grandes", "DF", "1081", "Venezuela", 66.29));
            ...
            list.Add(new EmployeeData(10273, "QUICK", 3, 8391834, "QUICK-Stop", "Cunewalde", "Taucherstra�e 10", null, "01307", "Germany", 76.07));
            ...
            list.Add(new EmployeeData(10276, "TORTU", 8, 8394426, "Tortuga Restaurante", "M�xico D.F.", "Avda. Azteca 123", null, "05033", "Mexico", 13.84));
            list.Add(new EmployeeData(10277, "MORGK", 2, 839529, "Morgenstern Gesundkost", "Leipzig", "Heerstr. 22", null, "04179", "Germany", 125.77));
            list.Add(new EmployeeData(10278, "BERGS", 8, 8397882, "Berglunds snabbk�p", "Lule�", "Berguvsv�gen  8", null, "S-958 22", "Sweden", 92.69));
            list.Add(new EmployeeData(10279, "LEHMS", 8, 8398746, "Lehmanns Marktstand", "Frankfurt a.M.", "Magazinweg 7", null, "60528", "Germany", 25.83));
            list.Add(new EmployeeData(10280, "BERGS", 2, 839961, "Berglunds snabbk�p", "Lule�", "Berguvsv�gen  8", null, "S-958 22", "Sweden", 8.98));
            list.Add(new EmployeeData(10281, "ROMEY", 4, 839961, "Romero y tomillo", "Madrid", "Gran V�a, 1", null, "28001", "Spain", 2.94));
            list.Add(new EmployeeData(10282, "ROMEY", 4, 8400474, "Romero y tomillo", "Madrid", "Gran V�a, 1", null, "28001", "Spain", 12.69));
            list.Add(new EmployeeData(10283, "LILAS", 3, 8401338, "LILA-Supermercado", "Barquisimeto", "Carrera 52 con Ave. Bol�var #65-98 Llano Largo", "Lara", "3508", "Venezuela", 84.81));
            list.Add(new EmployeeData(10284, "LEHMS", 4, 840393, "Lehmanns Marktstand", "Frankfurt a.M.", "Magazinweg 7", null, "60528", "Germany", 76.56));
            list.Add(new EmployeeData(10285, "QUICK", 1, 8404794, "QUICK-Stop", "Cunewalde", "Taucherstra�e 10", null, "01307", "Germany", 76.83));
            list.Add(new EmployeeData(10286, "QUICK", 8, 8405658, "QUICK-Stop", "Cunewalde", "Taucherstra�e 10", null, "01307", "Germany", 229.24));
            ...
            list.Add(new EmployeeData(10290, "COMMI", 8, 8410842, "Com�rcio Mineiro", "Sao Paulo", "Av. dos Lus�adas, 23", "SP", "05432-043", "Brazil", 79.7));
            list.Add(new EmployeeData(10291, "QUEDE", 6, 8410842, "Que Del�cia", "Rio de Janeiro", "Rua da Panificadora, 12", "RJ", "02389-673", "Brazil", 6.4));
            list.Add(new EmployeeData(10292, "TRADH", 1, 8411706, "Tradi�ao Hipermercados", "Sao Paulo", "Av. In�s de Castro, 414", "SP", "05634-030", "Brazil", 1.35));
            list.Add(new EmployeeData(10293, "TORTU", 1, 841257, "Tortuga Restaurante", "M�xico D.F.", "Avda. Azteca 123", null, "05033", "Mexico", 21.18));
            ...
            list.Add(new EmployeeData(10296, "LILAS", 6, 841689, "LILA-Supermercado", "Barquisimeto", "Carrera 52 con Ave. Bol�var #65-98 Llano Largo", "Lara", "3508", "Venezuela", .12));
            list.Add(new EmployeeData(10297, "BLONP", 5, 8417754, "Blondel p�re et fils", "Strasbourg", "24, place Kl�ber", null, "67000", "France", 5.74));
            ...
            list.Add(new EmployeeData(10302, "SUPRD", 4, 8422938, "Supr�mes d�lices", "Charleroi", "Boulevard Tirou, 255", null, "B-6000", "Belgium", 6.27));
            list.Add(new EmployeeData(10303, "GODOS", 7, 8423802, "Godos Cocina T�pica", "Sevilla", "C/ Romero, 33", null, "41101", "Spain", 107.83));
            list.Add(new EmployeeData(10304, "TORTU", 1, 8424666, "Tortuga Restaurante", "M�xico D.F.", "Avda. Azteca 123", null, "05033", "Mexico", 63.79));
            list.Add(new EmployeeData(10305, "OLDWO", 8, 842553, "Old World Delicatessen", "Anchorage", "2743 Bering St.", "AK", "99508", "USA", 257.62));
            list.Add(new EmployeeData(10306, "ROMEY", 1, 8428122, "Romero y tomillo", "Madrid", "Gran V�a, 1", null, "28001", "Spain", 7.56));
            list.Add(new EmployeeData(10307, "LONEP", 2, 8428986, "Lonesome Pine Restaurant", "Portland", "89 Chiaroscuro Rd.", "OR", "97219", "USA", .56));
            list.Add(new EmployeeData(10308, "ANATR", 7, 842985, "Ana Trujillo Emparedados y helados", "M�xico D.F.", "Avda. de la Constituci�n 2222", null, "05021", "Mexico", 1.61));
            ...
            list.Add(new EmployeeData(10313, "QUICK", 2, 8435034, "QUICK-Stop", "Cunewalde", "Taucherstra�e 10", null, "01307", "Germany", 1.96));
            ...
            list.Add(new EmployeeData(10319, "TORTU", 7, 8441946, "Tortuga Restaurante", "M�xico D.F.", "Avda. Azteca 123", null, "05033", "Mexico", 64.5));
            ...
            list.Add(new EmployeeData(10322, "PERIC", 7, 8443674, "Pericles Comidas cl�sicas", "M�xico D.F.", "Calle Dr. Jorge Cash 321", null, "05033", "Mexico", .4));
            list.Add(new EmployeeData(10323, "KOENE", 4, 8446266, "K�niglich Essen", "Brandenburg", "Maubelstr. 90", null, "14776", "Germany", 4.88));
            list.Add(new EmployeeData(10324, "SAVEA", 9, 844713, "Save-a-lot Markets", "Boise", "187 Suffolk Ln.", "ID", "83720", "USA", 214.27));
            list.Add(new EmployeeData(10325, "KOENE", 1, 8447994, "K�niglich Essen", "Brandenburg", "Maubelstr. 90", null, "14776", "Germany", 64.86));
            list.Add(new EmployeeData(10326, "BOLID", 4, 8448858, "B�lido Comidas preparadas", "Madrid", "C/ Araquil, 67", null, "28023", "Spain", 77.92));
            list.Add(new EmployeeData(10327, "FOLKO", 2, 8449722, "Folk och f� HB", "Br�cke", "�kergatan 24", null, "S-844 67", "Sweden", 63.36));
            ...
            list.Add(new EmployeeData(10330, "LILAS", 3, 8454042, "LILA-Supermercado", "Barquisimeto", "Carrera 52 con Ave. Bol�var #65-98 Llano Largo", "Lara", "3508", "Venezuela", 12.75));
            list.Add(new EmployeeData(10331, "BONAP", 9, 8454042, "Bon app'", "Marseille", "12, rue des Bouchers", null, "13008", "France", 10.19));
            list.Add(new EmployeeData(10332, "MEREP", 3, 8454906, "M�re Paillarde", "Montr�al", "43 rue St. Laurent", "Qu�bec", "H1J 1C3", "Canada", 52.84));
            ...
            list.Add(new EmployeeData(10336, "PRINI", 7, 846009, "Princesa Isabel Vinhos", "Lisboa", "Estrada da sa�de n. 58", null, "1756", "Portugal", 15.51));
            list.Add(new EmployeeData(10337, "FRANK", 4, 8460954, "Frankenversand", "M�nchen", "Berliner Platz 43", null, "80805", "Germany", 108.26));
            list.Add(new EmployeeData(10338, "OLDWO", 4, 8461818, "Old World Delicatessen", "Anchorage", "2743 Bering St.", "AK", "99508", "USA", 84.21));
            list.Add(new EmployeeData(10339, "MEREP", 2, 846441, "M�re Paillarde", "Montr�al", "43 rue St. Laurent", "Qu�bec", "H1J 1C3", "Canada", 15.66));
            list.Add(new EmployeeData(10340, "BONAP", 1, 8465274, "Bon app'", "Marseille", "12, rue des Bouchers", null, "13008", "France", 166.31));
            list.Add(new EmployeeData(10341, "SIMOB", 7, 8465274, "Simons bistro", "Kobenhavn", "Vinb�ltet 34", null, "1734", "Denmark", 26.78));
            list.Add(new EmployeeData(10342, "FRANK", 4, 8466138, "Frankenversand", "M�nchen", "Berliner Platz 43", null, "80805", "Germany", 54.83));
            ...
            list.Add(new EmployeeData(10345, "QUICK", 2, 8470458, "QUICK-Stop", "Cunewalde", "Taucherstra�e 10", null, "01307", "Germany", 249.06));
            ...
            list.Add(new EmployeeData(10347, "FAMIA", 4, 8472186, "Familia Arquibaldo", "Sao Paulo", "Rua Or�s, 92", "SP", "05442-030", "Brazil", 3.1));
            ...
            list.Add(new EmployeeData(10354, "PERIC", 8, 8479098, "Pericles Comidas cl�sicas", "M�xico D.F.", "Calle Dr. Jorge Cash 321", null, "05033", "Mexico", 53.8));
            ...
            list.Add(new EmployeeData(10357, "LILAS", 1, 8483418, "LILA-Supermercado", "Barquisimeto", "Carrera 52 con Ave. Bol�var #65-98 Llano Largo", "Lara", "3508", "Venezuela", 34.88));
            ...
            list.Add(new EmployeeData(10360, "BLONP", 4, 848601, "Blondel p�re et fils", "Strasbourg", "24, place Kl�ber", null, "67000", "France", 131.7));
            list.Add(new EmployeeData(10361, "QUICK", 1, 848601, "QUICK-Stop", "Cunewalde", "Taucherstra�e 10", null, "01307", "Germany", 183.17));
            ...
            list.Add(new EmployeeData(10365, "ANTON", 3, 849033, "Antonio Moreno Taquer�a", "M�xico D.F.", "Mataderos  2312", null, "05023", "Mexico", 22));
            list.Add(new EmployeeData(10366, "GALED", 8, 8491194, "Galer�a del gastron�mo", "Barcelona", "Rambla de Catalu�a, 23", null, "8022", "Spain", 10.14));
            list.Add(new EmployeeData(10367, "VAFFE", 7, 8491194, "Vaffeljernet", "�rhus", "Smagsloget 45", null, "8200", "Denmark", 13.55));
            ...
            list.Add(new EmployeeData(10372, "QUEEN", 5, 8496378, "Queen Cozinha", "Sao Paulo", "Alameda dos Can�rios, 891", "SP", "05487-020", "Brazil", 890.78));
            ...
            list.Add(new EmployeeData(10376, "MEREP", 1, 8500698, "M�re Paillarde", "Montr�al", "43 rue St. Laurent", "Qu�bec", "H1J 1C3", "Canada", 20.39));
            list.Add(new EmployeeData(10377, "SEVES", 1, 8500698, "Seven Seas Imports", "London", "90 Wadhurst Rd.", null, "OX15 4NB", "UK", 22.21));
            list.Add(new EmployeeData(10378, "FOLKO", 5, 8501562, "Folk och f� HB", "Br�cke", "�kergatan 24", null, "S-844 67", "Sweden", 5.44));
            list.Add(new EmployeeData(10379, "QUEDE", 2, 8502426, "Que Del�cia", "Rio de Janeiro", "Rua da Panificadora, 12", "RJ", "02389-673", "Brazil", 45.03));
            ...
            list.Add(new EmployeeData(10381, "LILAS", 3, 850329, "LILA-Supermercado", "Barquisimeto", "Carrera 52 con Ave. Bol�var #65-98 Llano Largo", "Lara", "3508", "Venezuela", 7.99));
            ...
            list.Add(new EmployeeData(10384, "BERGS", 3, 8506746, "Berglunds snabbk�p", "Lule�", "Berguvsv�gen  8", null, "S-958 22", "Sweden", 168.64));
            list.Add(new EmployeeData(10385, "SPLIR", 1, 850761, "Split Rail Beer & Ale", "Lander", "P.O. Box 555", "WY", "82520", "USA", 30.96));
            list.Add(new EmployeeData(10386, "FAMIA", 9, 8508474, "Familia Arquibaldo", "Sao Paulo", "Rua Or�s, 92", "SP", "05442-030", "Brazil", 13.99));
            list.Add(new EmployeeData(10387, "SANTG", 1, 8508474, "Sant� Gourmet", "Stavern", "Erling Skakkes gate 78", null, "4110", "Norway", 93.63));
            ...
            list.Add(new EmployeeData(10395, "HILAA", 6, 8515386, "HILARION-Abastos", "San Crist�bal", "Carrera 22 con Ave. Carlos Soublette #8-35", "T�chira", "5022", "Venezuela", 184.41));
            list.Add(new EmployeeData(10396, "FRANK", 1, 851625, "Frankenversand", "M�nchen", "Berliner Platz 43", null, "80805", "Germany", 135.35));
            list.Add(new EmployeeData(10397, "PRINI", 5, 851625, "Princesa Isabel Vinhos", "Lisboa", "Estrada da sa�de n. 58", null, "1756", "Portugal", 60.26));
            list.Add(new EmployeeData(10398, "SAVEA", 2, 8518842, "Save-a-lot Markets", "Boise", "187 Suffolk Ln.", "ID", "83720", "USA", 89.16));
            list.Add(new EmployeeData(10399, "VAFFE", 8, 8519706, "Vaffeljernet", "�rhus", "Smagsloget 45", null, "8200", "Denmark", 27.36));
            ...
            list.Add(new EmployeeData(10406, "QUEEN", 7, 8525754, "Queen Cozinha", "Sao Paulo", "Alameda dos Can�rios, 891", "SP", "05487-020", "Brazil", 108.04));
            list.Add(new EmployeeData(10407, "OTTIK", 2, 8525754, "Ottilies K�seladen", "K�ln", "Mehrheimerstr. 369", null, "50739", "Germany", 91.48));
            list.Add(new EmployeeData(10408, "FOLIG", 8, 8526618, "Folies gourmandes", "Lille", "184, chauss�e de Tournai", null, "59000", "France", 11.26));
            list.Add(new EmployeeData(10409, "OCEAN", 3, 8527482, "Oc�ano Atl�ntico Ltda.", "Buenos Aires", "Ing. Gustavo Moncada 8585 Piso 20-A", null, "1010", "Argentina", 29.83));
            ...
            list.Add(new EmployeeData(10414, "FAMIA", 2, 8531802, "Familia Arquibaldo", "Sao Paulo", "Rua Or�s, 92", "SP", "05442-030", "Brazil", 21.48));
            ...
            list.Add(new EmployeeData(10417, "SIMOB", 4, 853353, "Simons bistro", "Kobenhavn", "Vinb�ltet 34", null, "1734", "Denmark", 70.29));
            list.Add(new EmployeeData(10418, "QUICK", 4, 8534394, "QUICK-Stop", "Cunewalde", "Taucherstra�e 10", null, "01307", "Germany", 17.55));
            list.Add(new EmployeeData(10419, "RICSU", 4, 8536986, "Richter Supermarkt", "Gen�ve", "Starenweg 5", null, "1204", "Switzerland", 137.35));
            ...
            list.Add(new EmployeeData(10421, "QUEDE", 8, 853785, "Que Del�cia", "Rio de Janeiro", "Rua da Panificadora, 12", "RJ", "02389-673", "Brazil", 99.23));
            ...
            list.Add(new EmployeeData(10424, "MEREP", 7, 8539578, "M�re Paillarde", "Montr�al", "43 rue St. Laurent", "Qu�bec", "H1J 1C3", "Canada", 370.61));
            list.Add(new EmployeeData(10425, "LAMAI", 6, 8540442, "La maison d'Asie", "Toulouse", "1 rue Alsace-Lorraine", null, "31000", "France", 7.93));
            list.Add(new EmployeeData(10426, "GALED", 4, 8543034, "Galer�a del gastron�mo", "Barcelona", "Rambla de Catalu�a, 23", null, "8022", "Spain", 18.69));
            ...
            list.Add(new EmployeeData(10433, "PRINI", 3, 8549082, "Princesa Isabel Vinhos", "Lisboa", "Estrada da sa�de n. 58", null, "1756", "Portugal", 73.83));
            list.Add(new EmployeeData(10434, "FOLKO", 3, 8549082, "Folk och f� HB", "Br�cke", "�kergatan 24", null, "S-844 67", "Sweden", 17.92));
            ...
            list.Add(new EmployeeData(10436, "BLONP", 3, 855081, "Blondel p�re et fils", "Strasbourg", "24, place Kl�ber", null, "67000", "France", 156.66));
            list.Add(new EmployeeData(10437, "WARTH", 8, 855081, "Wartian Herkku", "Oulu", "Torikatu 38", null, "90110", "Finland", 19.97));
            list.Add(new EmployeeData(10438, "TOMSP", 3, 8551674, "Toms Spezialit�ten", "M�nster", "Luisenstr. 48", null, "44087", "Germany", 8.24));
            list.Add(new EmployeeData(10439, "MEREP", 6, 8552538, "M�re Paillarde", "Montr�al", "43 rue St. Laurent", "Qu�bec", "H1J 1C3", "Canada", 4.07));
            ...
            list.Add(new EmployeeData(10444, "BERGS", 3, 8556858, "Berglunds snabbk�p", "Lule�", "Berguvsv�gen  8", null, "S-958 22", "Sweden", 3.5));
            list.Add(new EmployeeData(10445, "BERGS", 3, 8557722, "Berglunds snabbk�p", "Lule�", "Berguvsv�gen  8", null, "S-958 22", "Sweden", 9.3));
            list.Add(new EmployeeData(10446, "TOMSP", 6, 8558586, "Toms Spezialit�ten", "M�nster", "Luisenstr. 48", null, "44087", "Germany", 14.68));
