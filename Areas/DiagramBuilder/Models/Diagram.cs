...
{
    public class DiagramBuilderModel
    {
        public DiagramBuilderModel()
        {
            InitializeDiagram();
        }
        private void InitializeDiagram()
        {
            ...
            _model.Width = "100%";
            _model.Height = "100%";
            _model.PageSettings.PageWidth = 1100;
            _model.PageSettings.PageHeight = 1200;
            _model.PageSettings.ShowPageBreak = false;
            _model.PageSettings.MultiplePage = true;
            _model.PageSettings.ScrollLimit = ScrollLimit.Infinity;
            List<decimal> intervals = new List<decimal>();
            intervals.Add(.95m);
            intervals.Add(9.05m);
            intervals.Add(0.2m);
            intervals.Add(9.75m);
            _model.SnapSettings.HorizontalGridlines = new GridLines();
            _model.SnapSettings.HorizontalGridlines.SnapInterval.Add(10);
            _model.SnapSettings.HorizontalGridlines.LinesInterval = intervals;
            _model.SnapSettings.VerticalGridlines = new GridLines();
            _model.SnapSettings.VerticalGridlines.SnapInterval.Add(10);
            _model.SnapSettings.VerticalGridlines.LinesInterval = intervals;
            _model.SelectedItems.Constraints = SelectorConstraints.All | SelectorConstraints.Tooltip;
            
            _model.Nodes.Add(manufacturing);
            _model.Nodes.Add(simProjection);
            _model.Nodes.Add(manufacturingProcess);
            _model.Nodes.Add(dualSim);
            _model.Nodes.Add(touch);
            _model.Nodes.Add(capacitiveTouch);
            _model.Nodes.Add(resistiveTouch);
            _model.Nodes.Add(standards);
            _model.Nodes.Add(price);
            _model.Nodes.Add(selling);
            _model.SelectionChange = "selectionChange";
            _model.Drop = "drop";
            _model.DragEnter = "dragEnter";
            _model.NodeCollectionChange = "nodeCollectionChange";
            _model.SizeChange = "nodeSizeChanging";
            _model.ConnectorCollectionChange = "connectorCollectionChange";
            _model.TextChange = "textChange";
            _model.Drag = "drag";
            _model.Create = "create";

            var labels = new Collection();
            labels.Add(new Label() { FillColor = "white" });
            _model.DefaultSettings.Connector = new Connector() { CornerRadius = 8, Labels = labels };
            _model.DefaultSettings.Node = new Node()
            {
            ...
            _model.SnapSettings.SnapConstraints = SnapConstraints.All & ~SnapConstraints.SnapToLines;
            _model.ContextMenu = new DiagramContextMenu()
            {
                Items = CustomContextMenuItem()
            };
            _model.ContextMenuBeforeOpen = "contextMenuBeforeOpen";
            _model.ContextMenuClick = "contextMenuClick";
        ...
        public ContextMenuItem createMenuItem(string name, string text)
        {
            ...
            item.Text = text;
            item.Name = name;
            item.ImageUrl = "../../Content/diagram/images/" + name + ".png";
        ...
        public void Palette(SymbolPaletteProperties symbolpalettes)
        {
            ...
            symbolpalettes.PreviewHeight = 100;
            symbolpalettes.PreviewWidth = 100;
            symbolpalettes.SelectedPaletteName = "Basic Shapes";
            symbolpalettes.ShowPaletteItemText = false;
        ...
        private void CreateConnector(Node targetNode, Node sourceNode, string labelText, string sourcePort, string targetPort)
        {
            ...
            connector.Name = "line" + _model.Connectors.Count + 1;
            ...
            _model.Connectors.Add(connector);
        }
        ...
        public void GenerateBasicShapes(SymbolPaletteProperties symbolPalettes)
        {
            ...
            (basicShapes.AddInfo as Dictionary<string, object>).Add("source", "~/Content/diagram/images/basic.png");
        ...
        public void GenerateFlowShapes(SymbolPaletteProperties symbolPalettes)
        {
            ...
            (flowShapes.AddInfo as Dictionary<string, object>).Add("source", "~/Content/diagram/images/flow.png");
            NodeConstraints constraints = NodeConstraints.Default | NodeConstraints.AspectRatio;
            ...
            symbolPalettes.Palettes.Add(flowShapes);
        }
        public void GenerateArrowShapes(SymbolPaletteProperties symbolPalettes)
        {
            ...
            (arrowShapes.AddInfo as Dictionary<string, object>).Add("source", "~/Content/diagram/images/arrow.png");
            float x = 0;
            float y = 0;
            ...
            symbolPalettes.Palettes.Add(arrowShapes);
        }
        public void GenerateElectricalShapes(SymbolPaletteProperties symbolPalettes)
        {
            ...
            (electricalShapes.AddInfo as Dictionary<string, object>).Add("source", "~/Content/diagram/images/electrical.png");
        ...
        public void GenerateBpmnShapes(SymbolPaletteProperties symbolPalettes)
        {
            ...
            (bpmnShapes.AddInfo as Dictionary<string, object>).Add("source", "~/Content/diagram/images/bpmn.png");
            ...
            symbolPalettes.Palettes.Add(bpmnShapes);
        }
        ...
        public void GenerateConnectors(SymbolPaletteProperties symbolPalettes)
        {
            ...
            (connectors.AddInfo as Dictionary<string, object>).Add("source", "~/Content/diagram/images/connector.png");
        ...
        public void GenerateSwimLanes(SymbolPaletteProperties symbolPalettes)
        {
            ...
            (swimLanes.AddInfo as Dictionary<string, object>).Add("source", "~/Content/diagram/images/swimlane.png");
            ...
            symbolPalettes.Palettes.Add(swimLanes);
        }
        ...
        private DiagramProperties _model = new DiagramProperties();
        public DiagramProperties Model
        {
            get { return _model; }
        }
